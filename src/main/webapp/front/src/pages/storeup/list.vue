<template>
	<div :style='{"width":"100%","padding":"20px","margin":"10px auto","position":"relative","background":"none","maxWidth":"1200px"}'>
		<div class="back_box">
		...
		<div v-if="storeupType==1" class="section-title" :style='{"padding":"0","margin":"0 auto 20px auto","color":"#000","textAlign":"center","background":"none","borderWidth":"0","width":"100%","letterSpacing":"2px","lineHeight":"70px","fontSize":"22px","fontWeight":"600"}'>我的收藏</div>
		...
		<el-pagination
			...
			:total="total"
			:style='{"padding":"0","margin":"10px auto","whiteSpace":"nowrap","color":"#333","width":"100%","fontWeight":"500","order":"6","maxWidth":"1300px"}'
