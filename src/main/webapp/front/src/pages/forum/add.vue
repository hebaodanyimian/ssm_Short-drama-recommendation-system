<template>
	<div :style='{"width":"100%","padding":"20px","margin":"20px auto","position":"relative","background":"none","maxWidth":"1200px"}'>
		<div class="section-title" :style='{"padding":"0","margin":"0 auto 20px auto","color":"#000","textAlign":"center","background":"none","borderWidth":"0","width":"100%","letterSpacing":"2px","lineHeight":"70px","fontSize":"22px","fontWeight":"600"}'>互动论坛</div>
		<div class="back_box">
		...
		<el-form class="add-update-preview" :model="form" :rules="rules" ref="form" label-width="120px">
			<el-form-item :style='{"width":"calc(50% - 10px)","padding":"10px","margin":"0 0 10px","background":"none"}' label="标题" prop="title">
				<el-input v-model="form.title" placeholder="请输入标题"></el-input>
			</el-form-item>
			<el-form-item :style='{"width":"calc(50% - 10px)","padding":"10px","margin":"0 0 10px","background":"none"}' label="分类" prop="typename">
			...
			<el-form-item :style='{"width":"calc(50% - 10px)","padding":"10px","margin":"0 0 10px","background":"none"}' label="封面图" prop="cover">
				<file-upload
					tip="点击上传封面图"
					action="file/upload"
					:limit="3"
			...
			<el-form-item :style='{"width":"calc(50% - 10px)","padding":"10px","margin":"0 0 10px","background":"none"}' label="类型" prop="isdone">
				<el-radio-group v-model="form.isdone">
					<el-radio label="开放">公开</el-radio>
					<el-radio label="关闭">私人</el-radio>
				</el-radio-group>
			</el-form-item>
			<el-form-item :style='{"width":"calc(50% - 10px)","padding":"10px","margin":"0 0 10px","background":"none"}' label="是否匿名" prop="isanon">
				<el-radio-group v-model="form.isanon">
					<el-radio :label="1">是</el-radio>
					<el-radio :label="0">否</el-radio>
				</el-radio-group>
			</el-form-item>
			<el-form-item :style='{"width":"calc(50% - 10px)","padding":"10px","margin":"0 0 10px","background":"none"}' label="内容" prop="content">
				<editor
			...
			<el-form-item :style='{"padding":"0","margin":"0"}'>
				<el-button :style='{"border":"0","cursor":"pointer","padding":"0 15px","margin":"0 20px 0 0","outline":"none","borderRadius":"4px","background":"#37A679","display":"inline-block","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' type="primary" @click="submitForm('form')">
				...
				<el-button :style='{"border":"none","cursor":"pointer","padding":"0 15px","margin":"0 20px 0 0","outline":"none","borderRadius":"4px","background":"#E8E8E8","display":"inline-block","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' @click="resetForm('form')">
					<span class="icon iconfont icon-shanchu1" :style='{"color":"#6E6E6E"}'></span>
					<span class="text" :style='{"color":"#6E6E6E"}'>重置</span>
				</el-button>
			</el-form-item>
		</el-form>
	</div>
