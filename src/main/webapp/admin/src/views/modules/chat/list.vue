		...
		<div v-if="!showFlag" style="width: 100%;">
			<el-form :style='{"margin":"0"}' :inline="true" :model="searchForm" class="center-form-pv">
				<el-row :style='{"padding":"10px","background":"#fff","display":"block"}'>
					...
					<el-button class="search" :style='{"border":"0","cursor":"pointer","padding":"0 10px","color":"#fff","borderRadius":"0px","background":"#046D66","width":"auto","fontSize":"16px","height":"34px"}' type="success" @click="search()">
				...
				<el-table
					...
					<el-table-column
						...
						<template slot-scope="scope">
							<el-button
								type="text"
								:style='{"border":"0px solid #157ed2","cursor":"pointer","padding":"0 10px","margin":"0 5px 5px 0","color":"#fff","borderRadius":"5px","background":"#25B080","width":"auto","fontSize":"14px","height":"32px"}'
								size="small"
