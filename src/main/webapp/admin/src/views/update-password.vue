<template>
	<div :style='{"padding":"0","background":"url(http://codegen.caihongy.cn/20241017/fd4c1ba68428494cbd063d6d5e5ef753.webp) no-repeat bottom right #fff"}'>
		<el-form
			:style='{"width":"1200px","padding":"0 15% 0 0","borderColor":"#eee","margin":"0 auto","borderStyle":"solid","borderWidth":"0px 0 0"}'
		...
		>
			...
			<el-form-item :style='{"padding":"0","margin":"20px 0 0"}'>
				<el-button class="btn3" :style='{"border":"0px solid #ccc","cursor":"pointer","padding":"0 10px","margin":"0 10px 0 0","color":"#fff","borderRadius":"4px","background":"#46AF98","width":"auto","fontSize":"16px","minWidth":"110px","height":"40px"}' type="primary" @click="onUpdateHandler">
