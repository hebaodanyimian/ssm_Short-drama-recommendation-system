...
public class DuanjuxinxiEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public DuanjuxinxiEntity() {
		
	}
	
	public DuanjuxinxiEntity(T t) {
		try {
	 ...
	 * 设置：短剧标题
	 */
	public void setDuanjubiaoti(String duanjubiaoti) {
		this.duanjubiaoti = duanjubiaoti;
	}
	/**
	 * 获取：短剧标题
	 */
	public String getDuanjubiaoti() {
		return duanjubiaoti;
	}
	/**
	 * 设置：短剧分类
